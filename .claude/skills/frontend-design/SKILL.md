...
<!--
FILE FORMAT NOTE:
This file uses a custom format where `name:` and `description:` fields appear
BEFORE the `---` separator (not inside YAML frontmatter). This is intentional
for readability. See agents.md → "The Frontend-Design Skill" for format details.
-->
