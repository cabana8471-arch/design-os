...
- Includes: specs, code, comments, documentation, sample data labels

**When updating existing files with non-English content:**

- First, translate existing content to English
- Then, apply the requested modifications
- This ensures consistency across all files going forward

**Common violations to avoid:**

- (INCORRECT) Writing product-overview.md in the user's native language
- (INCORRECT) Using non-English variable names or comments
- (INCORRECT) Creating sample data with non-English labels
- (INCORRECT) Writing documentation in the conversation language
- (INCORRECT) Keeping non-English content when updating existing files

**How to follow:**

- (CORRECT) Always generate files in English, even if the user speaks another language
- (CORRECT) Use English for all code identifiers, comments, and documentation
- (CORRECT) Translate user requirements to English in generated files
- (CORRECT) Keep sample data labels and descriptions in English
- (CORRECT) When updating existing files, translate any non-English content before applying changes
