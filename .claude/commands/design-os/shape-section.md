...
- Section 5 (Section Depth): User flows, edge cases, empty/loading/error states
- Section 6 (UI Patterns): Data display preference, form validation, notifications
- Section 11 (Error Handling): Message style, retry behavior, undo/redo

These pre-inform section design in Steps 3, 4, and 4.5.
