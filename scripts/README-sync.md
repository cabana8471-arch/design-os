...
Boilerplate version: 0.0.0
Last sync: 2025-12-26T19:43:46Z (from v0.0.0)
...
```bash
# 1. Edit targets.txt with your project paths
# Example targets.txt:
# ~/projects/app-1
# ~/projects/app-2
# /Users/user/work/client-project

# 2. Synchronize all projects
