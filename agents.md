...
| -------------------- | ------- | --------------------------------------------------------------------------------------------------------------- |
| `/product-interview` | v1.3.3  | + Data loss warning for --skip-validation --minimal, Step execution order precedence                            |
| `/audit-context`     | v1.1.4  | + Implementation patterns for C-002/C-003/C-004/C-006/C-017/C-018, Logic check guidance, D-001/D-002 algorithms |
